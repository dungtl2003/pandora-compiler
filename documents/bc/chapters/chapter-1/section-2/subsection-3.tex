...
\begin{itemize}
    ...
    \item \textbf{Kiểm tra dòng điều khiển}. Có một số câu lệnh thay đổi dòng điều khiển từ một khối phải có một vài nơi để chuyển điều khiển đến đó. Ví dụ trong Pandora, khiến chương trình thay đổi thứ tự thực hiện các câu lệnh như  \kw{break}, \kw{continue}, \dots (Trong Pandora tương ứng là các câu lệnh \kw{br}, \kw{skip}). Trình thông dịch sẻ kiểm tra để đảm bảo các câu lệnh này nằm bên trong một vòng lặp không.
