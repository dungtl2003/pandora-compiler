...
\begin{itemize}
    ...
    \item \textbf{Mong chờ tên}. Lỗi này sẽ xảy ra khi trình thông dịch phân tích một câu lệnh và mong chờ một từ tố tên nhưng tìm thấy một từ tố khác. Ví dụ trong câu lệnh vòng lặp trình lặp thì sau từ khóa \kw{for} thì sẽ là tên biến, \dots
\end{itemize}
