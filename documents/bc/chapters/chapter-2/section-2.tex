...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        \node[text width=2cm,align=center](textabove)[above=of lexer,xshift = 2.5cm, yshift = -1.5cm]{Yêu cầu lấy từ tố tiếp theo}; 
        \node[text width=2cm,align=center](textbelow)[below=of lexer,xshift = 2.5cm, yshift = 1.5cm]{Từ tố}; 
        \node[text width=1.5cm,align=center](textaboveparser)[above=of parser,xshift = 2.2cm, yshift = -1.5cm]{Cây phân tích}; 
    ...
    \end{tikzpicture}
    \caption{Vị trí của phần phân tích cú pháp trong trình biên dịch.}
