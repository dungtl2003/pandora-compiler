...
%   \item Delimiter là 1 chuỗi các từ tố thứ cấp được đặt trong 1 cặp đóng mở ngoặc, nó gồm 3 giá trị:
%         \begin{itemize}
%           \item DelimSpan lưu trữ giá trị của vị trí mở ngoặc và đóng ngoặc
%                 \begin{lstlisting}
...
%                   }
%                 \end{lstlisting}
%           \item TokenStream con trỏ trỏ đến 1 danh sách các từ tố thứ cấp
%                 \begin{lstlisting}
...
% Hàm \textit{lex\_token\_trees} sẽ đọc các từ tố sơ cấp nhận được từ giai đoạn 1 và "\textit{nấu}" chúng thành từ tố thứ cấp:
% \begin{lstlisting}
...
% Cụ thể:
% \begin{itemize}
%   \item Nếu token đang được đọc là dấu mở ngoặc
% \end{itemize}